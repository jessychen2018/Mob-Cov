...
def scales_to_loc(scales_vector, comb, space=True):
    ...
    '''
    ticks_prod = [1] + list(np.cumprod(comb))  #【1, n1, n1n2, n1n2n3】
    size_of_the_box = ticks_prod[-1]  #n1n2n3
...
class ContainerModel():
    ...
    def run_simulation(self, iterations):
        self.positions, self.positions_scales, self.nested_dictionary, self.bernullis, self.betas = run_simulation(
            iterations, self.comb, self.n_scales, self.c0, self.c1, self.d)
